                    ...
                    <ListItem>
                        <ListItemAvatar>
                            <Badge variant="dot" color="success">
                                <Avatar src={currentChatSelect.currentChat.avatarImage}></Avatar>
                            </Badge>
                        </ListItemAvatar>
                        <ListItemText
                            sx={{
                            ...
                            primary={
                                currentChatSelect.currentChat.first_name + ' ' + currentChatSelect.currentChat.last_name
                            }
                            secondary={'online'}
                        ></ListItemText>
                    </ListItem>
                ...
                {currentChatSelect.typeChat === 1 && (
                    ...
                    <ListItem>
                        <ListItemAvatar>
                            <Badge variant="dot" color="success">
                                <Avatar
                                    src={currentChatSelect.currentChat.avatarImage}
                                ></Avatar>
                            </Badge>
                        </ListItemAvatar>
                        <ListItemText
